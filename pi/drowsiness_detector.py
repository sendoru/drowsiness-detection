...
def init_message() :
    print("init_message")
    alarm.sound_alarm("/home/pi/Desktop/drowsiness-detection-master/init_sound.mp3")
...
#1.
OPEN_EAR = 280 #For init_open_ear()
EAR_THRESH = 160 #Threashold value
...
predictor = dlib.shape_predictor("/home/pi/Desktop/drowsiness-detection-master/shape_predictor_68_face_landmarks.dat")
...
while True:
    ...
    for rect in rects:
        ...
        both_ear = (leftEAR + rightEAR) * 1000  #I multiplied by 1000 to enlarge the scope.
    ...
    try:
        cv2.putText(frame, "EAR : {:.2f}".format(both_ear), (160,60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,0,0), 2)
